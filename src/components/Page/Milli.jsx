    ...
    <>
      <div className="lastBlock cuisineItems">
        <div className="container flex center newItemBlock mx-12">
          {/* Bütün qruplarda (array daxilində) "Milli Şirniyyat" kateqoriyasına aid olan məhsulları filtr edirik */}
          {products
            .flat() // Bütün qrupları birləşdiririk
            .filter((product) => product.category === 'Milli Şirniyyat') // Yalnız "Milli Şirniyyat" olanları filtr edirik
            .map((product) => (
