    ...
    <>
      <div className="lastBlock cuisineItems">
        <div className="container flex center newItemBlock mx-12">
          {/* Bütün qruplarda (array daxilində) "Piroq" kateqoriyasına aid olan məhsulları filtr edirik */}
          {products
            .flat() // Bütün qrupları birləşdiririk
            .filter((product) => product.category === 'Piroq') // Yalnız "Piroq" olanları filtr edirik
            .map((product) => (
